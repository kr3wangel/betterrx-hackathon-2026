...
/** The trip's receipt speaks for the stop, and names anything the yes could not cover. */
export function groupAckText(digit: string, appliedCount: number, skipped: string[]): string {
