...
export function seedFixtures() {
  db.exec(
    'DELETE FROM condition_reports; DELETE FROM pods; DELETE FROM escalations; DELETE FROM messages; DELETE FROM order_events; DELETE FROM orders; DELETE FROM vendor_stats; DELETE FROM vendors; DELETE FROM patients;',
  )
  db.prepare(
