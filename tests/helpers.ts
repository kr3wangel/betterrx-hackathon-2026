...
export function seedFixtures() {
  db.exec(
    'DELETE FROM vendor_capacity; DELETE FROM condition_reports; DELETE FROM pods; DELETE FROM escalations; DELETE FROM message_orders; DELETE FROM messages; DELETE FROM order_events; DELETE FROM orders; DELETE FROM vendor_stats; DELETE FROM vendors; DELETE FROM patients;',
  )
  db.prepare(
