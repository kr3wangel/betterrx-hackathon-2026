...
- [ ] **S · "Delivered without POD" flag** — a vendor *texting* "delivered" currently applies the same as a driver POD; add an escalation or visible "unverified" marker for message-sourced deliveries.
...
- [ ] **Slides** — 4–5, demo-first: problem in hospices' words → cold-start insight → demo → AI-ROI/safety close; integration diagram is one slide.
